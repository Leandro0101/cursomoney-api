...
import com.example.cursomoney.api.repository.CategoriaRepository;
...
//	}
	...
	public ResponseEntity<?> buscarPeloCodigo(@PathVariable Long codigo) {
		...
		return categoriaBuscada.isPresent() ? ResponseEntity.ok(categoriaBuscada) : ResponseEntity.notFound().build();
	}
}